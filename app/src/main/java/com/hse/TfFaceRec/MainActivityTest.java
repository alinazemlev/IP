...
import com.asav.android.*;
import com.asav.android.MainActivity;
import com.asav.android.db.ImageAnalysisResults;


public class MainActivityTest extends FragmentActivity{
    private static final String[] categoryList = {"Male","Women"};
    ...
    private com.asav.android.PhotoProcessor photoProcessor = null;
    ...
    private void init(){
        ...
        preferencesFragment = new com.asav.android.HighLevelVisualPreferences();
        ...
        photosFragment=new com.asav.android.Photos();
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS:
                ...
                if (allGranted) {
                    ...
                    // Permission Denied
                    Toast.makeText(MainActivityTest.this, "Some Permission is Denied", Toast.LENGTH_SHORT)
                            .show();
                    finish();
                }
                break;
